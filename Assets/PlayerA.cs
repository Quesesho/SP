...
public partial class @PlayerA : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Cambiar"",
                    ""type"": ""Button"",
                    ""id"": ""3d84c6cb-a46a-4f9c-bbfe-97b5eddcbc2c"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""f94e03d7-d09a-439e-83c7-477ea68d7648"",
    ...
    ""controlSchemes"": [
        ...
        m_PlayerM_Cambiar = m_PlayerM.FindAction("Cambiar", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_PlayerM_Cambiar;
    public struct PlayerMActions
    {
        ...
        public InputAction @Cambiar => m_Wrapper.m_PlayerM_Cambiar;
        ...
        public void SetCallbacks(IPlayerMActions instance)
        {
            if (m_Wrapper.m_PlayerMActionsCallbackInterface != null)
            {
                ...
                @Cambiar.started -= m_Wrapper.m_PlayerMActionsCallbackInterface.OnCambiar;
                @Cambiar.performed -= m_Wrapper.m_PlayerMActionsCallbackInterface.OnCambiar;
                @Cambiar.canceled -= m_Wrapper.m_PlayerMActionsCallbackInterface.OnCambiar;
            }
